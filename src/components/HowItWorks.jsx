...
const HowItWorks = () => {
  return (
    <section className="py-xl md:py-32 px-margin-mobile" id="how-it-works">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-xl items-center">
            ...
            <div className="space-y-xl">
              ...
              <div className="flex gap-lg">
                ...
                <div>
                  ...
                  <p className="font-body-md text-body-md text-on-surface-variant">
                    Open the file, click Install, and start scanning your
                    garden immediately.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-surface-container rounded-lg p-xl relative overflow-hidden h-[500px]">
            <img
